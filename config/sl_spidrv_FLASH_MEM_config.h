...
#ifndef SL_SPIDRV_FLASH_MEM_CONFIG_H
#define SL_SPIDRV_FLASH_MEM_CONFIG_H
...
// <o SL_SPIDRV_FLASH_MEM_BITRATE> SPI bitrate
// <i> Default: 1000000
#define SL_SPIDRV_FLASH_MEM_BITRATE           1000000

// <o SL_SPIDRV_FLASH_MEM_FRAME_LENGTH> SPI frame length <4-16>
// <i> Default: 8
#define SL_SPIDRV_FLASH_MEM_FRAME_LENGTH      8

// <o SL_SPIDRV_FLASH_MEM_TYPE> SPI mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define SL_SPIDRV_FLASH_MEM_TYPE              spidrvMaster

// <o SL_SPIDRV_FLASH_MEM_BIT_ORDER> Bit order on the SPI bus
// <spidrvBitOrderLsbFirst=> LSB transmitted first
// <spidrvBitOrderMsbFirst=> MSB transmitted first
#define SL_SPIDRV_FLASH_MEM_BIT_ORDER         spidrvBitOrderMsbFirst

// <o SL_SPIDRV_FLASH_MEM_CLOCK_MODE> SPI clock mode
...
#define SL_SPIDRV_FLASH_MEM_CLOCK_MODE        spidrvClockMode0

// <o SL_SPIDRV_FLASH_MEM_CS_CONTROL> SPI master chip select (CS) control scheme.
// <spidrvCsControlAuto=> CS controlled by the SPI driver
// <spidrvCsControlApplication=> CS controlled by the application
#define SL_SPIDRV_FLASH_MEM_CS_CONTROL        spidrvCsControlApplication

// <o SL_SPIDRV_FLASH_MEM_SLAVE_START_MODE> SPI slave transfer start scheme
...
#define SL_SPIDRV_FLASH_MEM_SLAVE_START_MODE  spidrvSlaveStartImmediate
// </h>
// <<< end of configuration section >>>

// <<< sl:start pin_tool >>>
// <usart signal=TX,RX,CLK,(CS)> SL_SPIDRV_FLASH_MEM
...
#endif // SL_SPIDRV_FLASH_MEM_CONFIG_H
