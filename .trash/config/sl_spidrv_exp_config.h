...
// USART1 TX on PF5
#define SL_SPIDRV_EXP_TX_PORT                    gpioPortF
#define SL_SPIDRV_EXP_TX_PIN                     5
#define SL_SPIDRV_EXP_TX_LOC                     29

// USART1 RX on PF6
#define SL_SPIDRV_EXP_RX_PORT                    gpioPortF
#define SL_SPIDRV_EXP_RX_PIN                     6
#define SL_SPIDRV_EXP_RX_LOC                     29

// USART1 CLK on PF4
#define SL_SPIDRV_EXP_CLK_PORT                   gpioPortF
#define SL_SPIDRV_EXP_CLK_PIN                    4
#define SL_SPIDRV_EXP_CLK_LOC                    26

// USART1 CS on PF7
#define SL_SPIDRV_EXP_CS_PORT                    gpioPortF
#define SL_SPIDRV_EXP_CS_PIN                     7
#define SL_SPIDRV_EXP_CS_LOC                     28
// [USART_SL_SPIDRV_EXP]$
// <<< sl:end pin_tool >>>
